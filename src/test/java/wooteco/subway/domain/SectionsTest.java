...
class SectionsTest {
    ...
    void create() {
        List<Section> sections = List.of(
            new Section(new Line("2호선", "green"), new Station(1L, "강남"), new Station(2L, "삼성"), 12),
            new Section(new Line("2호선", "green"), new Station(2L, "삼성"), new Station(3L, "성수"), 12),
            new Section(new Line("2호선", "green"), new Station(4L, "노원"), new Station(1L, "강남"), 12)
        );
